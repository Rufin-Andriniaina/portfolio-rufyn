    ...
    <div id="home" className="flex flex-col items-center justify-center w-full min-h-screen isolate z-10 relative">
      ...
      <div className="flex flex-col items-center  xl:gap-y-10 md:gap-y-10 gap-y-3 xl:mb-0">
        <h1 className="flex flex-col xl:space-y-8 md:space-y-4 space-y-2 xl:text-6xl md:text-4xl text-3xl md:font-normal font-bold mt-8 md:mt-0">
          ...
          <span className="xl:text-6xl md:text-4xl text-xl tracking-wider xl:py-4 py-2 text-center overflow-hidden">
            I'm
            <span
        ...
        <div className="flex mr-auto md:gap-12 gap-2 absolute md:relative top-28 md:top-auto left-4  md:left-auto flex-col md:flex-row gap-y-5 md:gap-y-0 ">
        ...
        <div className="absolute lg:w-125 md:w-100 w-62.5 left-1/2 -translate-x-1/2 -z-10">
          <img
          ...
          <div
            className={`xl:h-37.5 h-23 px-3 xl:text-lg md:text-base text-xs font-light text-justify text-gray-950 dark:text-gray-200 tracking-wide ${
          ...
          >
            <p className=" dark:first-letter:text-yellow-500 first-letter:text-red-500 first-letter:text-[30px] first-letter:ml-4 px-1">
              {aboutText}
            </p>
          </div>
        </div>
