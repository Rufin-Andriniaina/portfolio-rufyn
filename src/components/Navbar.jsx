...
const Navbar = () => {
  ...
  return (
    <div className="w-full md:h-12 sm:h-14 h-18 mt-0 flex flex-col pt-3 md:flex-row justify-center md:justify-between items-center fixed top-0 xl:px-36 lg:px-24 md:px-12 sm:px-6 px-4 z-50 bg-white dark:bg-gray-900 transition-colors duration-500">
